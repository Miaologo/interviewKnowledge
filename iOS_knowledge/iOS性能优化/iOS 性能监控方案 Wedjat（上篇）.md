...
[沪江技术学院](https://www.jianshu.com/u/ebe59666d016)

2017.07.06 10:12* 字数 5714 阅读 1730评论 2喜欢 56

> 作者：敖志敏
> 本文为原创文章，转载请注明作者及出处

![img](https://upload-images.jianshu.io/upload_images/6560691-24b8c94d2e59c889.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/700)
...
![img](https://upload-images.jianshu.io/upload_images/6560691-c848b2d0811cb60a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/477)
...
注意方法最后要调用 `vm_deallocate`，防止出现内存泄漏。据测试，该方法采集的 **CPU**数据和腾讯的 [GT](https://link.jianshu.com/?t=https://github.com/Tencent/GT)、**Instruments** 数据接近。

> 由于监控 **CPU** 的线程也会占用 **CPU** 资源，所以为了让结果更客观，可以考虑在计算的时候将监控线程排除。

下面是 [GT](https://link.jianshu.com/?t=https://github.com/Tencent/GT) 中获得 App 的 **CPU** 占用率的方法
...
![img](https://upload-images.jianshu.io/upload_images/6560691-36a43ef5e10b1515.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/629)
...
![img](https://upload-images.jianshu.io/upload_images/6560691-67375936b560c74b.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/700)
...
![img](https://upload-images.jianshu.io/upload_images/6560691-ca382122b56cf34a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/700)
...
![img](https://upload-images.jianshu.io/upload_images/6560691-80f31909299a9a23.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/700)
...
这种方案需要链接 `iOSDiagnosticsSupport` 私有库，然后通过 **Runtime** 拿到 `MBSDevice`实例，调用 `copyPowerLogsToDir:` 方法将电量日志信息表（`PLBLMAccountingService_Aggregate_BLMAppEnergyBreakdown`）拷贝到硬盘的指定路径，日志信息表中包含了 iOS 系统采集的小时级别的耗电量。具体实现方案可以参考 [iOS-Diagnostics](https://link.jianshu.com/?t=https://github.com/lyonanderson/iOS-Diagnostics)。
...
- [Handling low memory conditions in iOS and Mavericks](https://link.jianshu.com/?t=http://newosxbook.com/articles/MemoryPressure.html)
- [iOS-System-Services](https://link.jianshu.com/?t=https://github.com/Shmoopi/iOS-System-Services)
- [GT](https://link.jianshu.com/?t=https://github.com/Tencent/GT)
- [Optimizing Facebook for iOS start time](https://link.jianshu.com/?t=https://code.facebook.com/posts/1675399786008080/optimizing-facebook-for-ios-start-time/)
- [Apple 文档：Strategies for Handling App State Transitions](https://link.jianshu.com/?t=https://developer.apple.com/library/content/documentation/iPhone/Conceptual/iPhoneOSProgrammingGuide/StrategiesforHandlingAppStateTransitions/StrategiesforHandlingAppStateTransitions.html)
- [iOS关于时间的处理](https://link.jianshu.com/?t=http://mrpeak.cn/blog/ios-time/)
- [StartupMeasurer](https://link.jianshu.com/?t=https://github.com/fealebenpae/StartupMeasurer)
- [Frame rate](https://link.jianshu.com/?t=https://en.wikipedia.org/wiki/Frame_rate)
- [YYText](https://link.jianshu.com/?t=https://github.com/ibireme/YYText)
- [移动端性能监控方案 Hertz](https://link.jianshu.com/?t=http://tech.meituan.com/hertz.html)
- [iOS 保持界面流畅的技巧](https://link.jianshu.com/?t=http://blog.ibireme.com/2015/11/12/smooth_user_interfaces_for_ios/)
- [微信读书 iOS 性能优化总结](https://link.jianshu.com/?t=https://wereadteam.github.io/2016/05/03/WeRead-Performance/)
- [PLCrashReporter](https://link.jianshu.com/?t=https://www.plcrashreporter.org/)
- [iOS-Diagnostics](https://link.jianshu.com/?t=https://github.com/lyonanderson/iOS-Diagnostics)
- [性能可视化实践之路](https://link.jianshu.com/?t=http://www.doc88.com/p-3072311816896.html)
- [iOS 性能监控 SDK —— Wedjat（华狄特）开发过程的调研和整理](https://aozhimin.github.io/iOS-Monitor-Platform/)
